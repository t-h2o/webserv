...
int main(int argc, char *argv[]) {
	...
	// la famille de socket AF_UNIX ou AF_LOCAL est utilisée pour communiquer efficassement entre processes sur la meme machine.
	// SOCK_STREAM est un socket stream-orientated. Cet appel retourne le nombre de bytes dans le buffer
	// receptionner.
	...
	// int bind(int sock_fd, const struct sock_addr *addr, socklen_t addr_len);
